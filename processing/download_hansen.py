#!/usr/bin/env python3
"""
Phase A: Download Hansen Global Forest Change data for Austria
Task 1: Download lossyear tile (40N_010E covers Austria)
"""
...
# Hansen GFC 2023 v1.11 tiles
HANSEN_BASE = "https://storage.googleapis.com/earthenginepartners-hansen/GFC-2023-v1.11"

# Tiles needed for Austria (46.4°N-49°N, 9.5°E-17.2°E)
# Tile 50N_010E covers 40-50°N, 10-20°E
TILES = {
    "lossyear": f"{HANSEN_BASE}/Hansen_GFC-2023-v1.11_lossyear_50N_010E.tif",
    "treecover2000": f"{HANSEN_BASE}/Hansen_GFC-2023-v1.11_treecover2000_50N_010E.tif",
}
